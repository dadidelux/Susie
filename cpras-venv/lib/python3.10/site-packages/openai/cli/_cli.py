...
def _main() -> None:
    ...
    raise Exception("The 'openai.http_client' option isn't read in the client API. You will need to pass it when you instantiate the client, e.g. 'OpenAI(http_client=http_client)'")

    if args.organization:
        raise Exception("The 'openai.organization' option isn't read in the client API. You will need to pass it when you instantiate the client, e.g. 'OpenAI(organization=args.organization)'")

    if args.api_key:
        

    if args.api_base:
        raise Exception("The 'openai.base_url' option isn't read in the client API. You will need to pass it when you instantiate the client, e.g. 'OpenAI(base_url=args.api_base)'")
    ...
    if args.azure_endpoint is not None:
        raise Exception("The 'openai.azure_endpoint' option isn't read in the client API. You will need to pass it when you instantiate the client, e.g. 'OpenAI(azure_endpoint=args.azure_endpoint)'")

    if args.api_version is not None:
        

    if args.azure_ad_token is not None:
        raise Exception("The 'openai.azure_ad_token' option isn't read in the client API. You will need to pass it when you instantiate the client, e.g. 'OpenAI(azure_ad_token=args.azure_ad_token)'")
